...
/**
 * A composable scaffold layout for the Oiid design system that extends
...
fun OiidScaffold(
    ...
    Scaffold(
        ...
        modifier = modifier.testTag(testTag ?: "OiidScaffold"),
...
fun OiidScaffold(
    ...
    Scaffold(
        ...
        modifier = modifier.testTag("OiidScaffold").fillMaxSize().navigationBarsPadding()
            .imePadding(),
    )
}
