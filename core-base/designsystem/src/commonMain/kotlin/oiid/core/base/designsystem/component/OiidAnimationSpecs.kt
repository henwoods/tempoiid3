...
import oiid.core.base.designsystem.component.OiidAnimationSpecs.fast
import oiid.core.base.designsystem.component.OiidAnimationSpecs.fastSpring
import oiid.core.base.designsystem.component.OiidAnimationSpecs.medium
import oiid.core.base.designsystem.component.OiidAnimationSpecs.mediumSpring
import oiid.core.base.designsystem.component.OiidAnimationSpecs.slow
import oiid.core.base.designsystem.component.OiidAnimationSpecs.slowSpring

/**
 * Centralized animation specifications following Material Motion design guidelines.
 *
 * This object provides consistent animation timing and easing curves throughout the Oiid design system.
 ...
 *     animationSpec = OiidAnimationSpecs.medium
 * )
 *
 * // For spring-based animations
 * val animatedScale by animateFloatAsState(
 *     targetValue = if (pressed) 0.95f else 1f,
 *     animationSpec = OiidAnimationSpecs.fastSpring
 * )
 * ```
 *
 * @see androidx.compose.animation.core.AnimationSpec
 */
object OiidAnimationSpecs {
    /**
...
fun AnimatedVisibilityScope.slideInFromStart(
    animationSpec: FiniteAnimationSpec<IntOffset> = tween(
        300,
        easing = OiidAnimationSpecs.emphasizedEasing,
    ),
