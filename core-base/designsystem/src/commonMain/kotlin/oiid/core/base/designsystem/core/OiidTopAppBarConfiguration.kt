...
/**
 * Configuration class that defines all properties for a Oiid top app bar.
 *
 ...
 * features while adding Oiid-specific enhancements.
 *
 * Example usage:
 * ```
 * val config = OiidTopAppBarConfiguration(
 *     title = "My Screen",
...
@Immutable
data class OiidTopAppBarConfiguration(
    val title: String,
...
/**
 * DSL builder class for creating [OiidTopAppBarConfiguration] instances.
 *
...
class OiidTopAppBarBuilder {
    ...
    /**
     * Builds the final [OiidTopAppBarConfiguration] with all specified properties.
     *
     * @return A configured [OiidTopAppBarConfiguration] instance
     */
    @OptIn(ExperimentalMaterial3Api::class)
    fun build(): OiidTopAppBarConfiguration = OiidTopAppBarConfiguration(
        title = title,
        modifier = modifier,
        variant = variant,
...
/**
 * DSL function for creating a [OiidTopAppBarConfiguration] using a builder pattern.
 *
 ...
 * Example usage:
 * ```
 * val topAppBarConfig = OiidTopAppBar {
 *     title = "My Screen"
 ...
 * }
 *
 * OiidTopAppBar(topAppBarConfig)
 * ```
 *
 * @param block Configuration block for building the top app bar
 * @return A fully configured [OiidTopAppBarConfiguration]
 *
 * @see OiidTopAppBarBuilder
 * @see OiidTopAppBarConfiguration
 */
fun oiidTopAppBar(block: OiidTopAppBarBuilder.() -> Unit): OiidTopAppBarConfiguration {
    return OiidTopAppBarBuilder().apply(block).build()
}
