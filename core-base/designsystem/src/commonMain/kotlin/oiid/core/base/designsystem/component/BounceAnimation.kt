...
import oiid.core.base.designsystem.OiidTheme
...
fun RevealAnimation(
    ...
    animationSpec: FiniteAnimationSpec<Float> = OiidAnimationSpecs.medium,
        ...
        items.forEachIndexed { index, item ->
            ...
            AnimatedVisibility(
                ...
                enter = slideInVertically(
                    initialOffsetY = { it },
                    animationSpec = tween(300, easing = OiidAnimationSpecs.emphasizedEasing),
