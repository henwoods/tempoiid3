 ...
 * - Windows: %APPDATA%/SuperfanDatabase
 * - macOS: ~/Library/Application Support/SuperfanDatabase
 * - Linux: ~/.local/share/SuperfanDatabase
 *
 * Key features:
...
class AppDatabaseFactory {
     ...
     * - Automatically creates the SuperfanDatabase directory if it does not exist
    ...
    inline fun <reified T : RoomDatabase> createDatabase(
        ...
        val appDataDir = when {
            os.contains("win") -> File(System.getenv("APPDATA"), "SuperfanDatabase")
            os.contains("mac") -> File(userHome, "Library/Application Support/SuperfanDatabase")
            else -> File(userHome, ".local/share/SuperfanDatabase")
        }
