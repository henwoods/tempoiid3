...
internal fun EditingProfileScreen(
    ...
    BoxWithConstraints(
        modifier = modifier.fillMaxSize().background(OiidTheme.colorScheme.background).imePadding(),
    ) {
        ...
        Column(
            modifier = Modifier.fillMaxWidth().fillMaxHeight(1f - imageHeightPercentage).align(Alignment.BottomCenter)
